...
<table style="padding-left: 200px;">
    ...
    <br/>
    <button onclick="window.location.href = 'updateAdminDetailsUI.php';" id = "button" style="margin-left: 260px;"> Update Details</button>
  ...
  <form action="#"  method="post">
	...
	<label>Name:</label>	 <input type="text" name="name" value ="<?php echo"$name"?>"><br><br>
       ...
       <label>City: </label> <input type="text" name="city" value ="<?php echo"$city"?>"><br><br>
		...
		<button type="submit" name="updateAdmin">Update Details</button>
	</form>
  </div>
    <br><br>
    <div id="myDIV" >
        ...
        <h4>Update Password</h4>
	    	...
	    	<button type="submit" name="updateAdminPassword">Update Password</button>
	    </form>
</div>
